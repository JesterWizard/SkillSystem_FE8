...
ldrb r0,[r4,r1]     @load the weapon ID for the attacker seperately by loading it as a byte instead of a short
...
mov r1,#0x1C        @get the weapon rank byte for attacker
...
cmp r2,r3
bge AttackerCheck 	@no damage -> Go to defender check
